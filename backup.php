...
if( isset($_GET['new']) ) {
	...
	$conn->query("INSERT INTO backups (owner_id, status, server_id, time) VALUES ('" . mysqli_real_escape_string($conn, $user->id) . "', 'queue', '" . mysqli_real_escape_string($conn, $_GET['serverid']) . "', '" . mysqli_real_escape_string($conn, time()) . "')");
